...
<div class="flex flex-col space-y-3">
    <x-breadcrumbs>
        ...
        <x-breadcrumbs-link link="/pekerja">Pekerja</x-breadcrumbs-link>
        <x-breadcrumbs-link current="true">Tambah Pekerja</x-breadcrumbs-link>
    </x-breadcrumbs>

    <x-page-header> Tambah Worker</x-page-header>
