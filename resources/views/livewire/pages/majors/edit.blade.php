                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('majors.update', $major) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="short_name">Nama Singkat <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control @error('short_name') is-invalid @enderror" 
                                           id="short_name" name="short_name" value="{{ old('short_name', $major->short_name) }}" 
                                           placeholder="Masukkan nama singkat" maxlength="10" required>
                                    @error('short_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
