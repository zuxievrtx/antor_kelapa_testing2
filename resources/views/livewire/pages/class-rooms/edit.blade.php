                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                           id="name" name="name" value="{{ old('name', $classRoom->name) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('grade') is-invalid @enderror" 
                                        ...
                                        <option value="1" {{ old('grade', $classRoom->grade) == 1 ? 'selected' : '' }}>Tingkat 1</option>
                                        <option value="2" {{ old('grade', $classRoom->grade) == 2 ? 'selected' : '' }}>Tingkat 2</option>
                                        <option value="3" {{ old('grade', $classRoom->grade) == 3 ? 'selected' : '' }}>Tingkat 3</option>
                                        <option value="4" {{ old('grade', $classRoom->grade) == 4 ? 'selected' : '' }}>Tingkat 4</option>
                                        <option value="5" {{ old('grade', $classRoom->grade) == 5 ? 'selected' : '' }}>Tingkat 5</option>
                                        <option value="6" {{ old('grade', $classRoom->grade) == 6 ? 'selected' : '' }}>Tingkat 6</option>
                                    </select>
                                    @error('grade')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
