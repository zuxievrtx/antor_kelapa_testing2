<div  x-on:close-import.window="isImportOpen = false">
    ...
    >
        <form wire:submit.prevent="importService">
            <x-dialog class="md:w-1/2">
                <x-slot name="header">
                    <h3>Import Pekerja</h3>                    
                ...
                <div class="flex flex-col space-y-2 px-4 py-6">    
                    <x-info>
                        Import hanya dari file hasil eksport data jasa.

                        <div class="mt-4">
                            <x-button-primary wireclick="exportExcel" color="green-500">
                                <x-fas-download class="h-4 w-4"/>    
                                <span> Export Jasa </span>
                            </x-button-primary>
                        </div>
                    </x-info>
