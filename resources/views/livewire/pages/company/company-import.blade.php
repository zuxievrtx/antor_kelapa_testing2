<div x-data="" x-on:open-import="isImportOpen = true" x-on:close-import.window="isImportOpen = false">
            ...
            <x-dialog class="md:w-1/2">
                ...
                <div class="flex flex-col space-y-2 px-4 py-6">    
                    <x-info>
                        ...
                        <div class="mt-4">
                            <x-button wireclick="downloadFormat()" color="green-500">
                                <x-fas-download class="h-4 w-4"/>    
                                <span> Download Format </span>
                            </x-button>
                        </div>
                    </x-info>
                    <x-input type="file" inline="false" label="File Import*" model="file"/>  
                </div>
                <x-slot name="footer">                    
